  ...
  return (
    <div className="min-h-screen relative bg-amber-700 grid grid-cols-2 p-4 font-[Montserrat]">
      {/* Div "Sheets" alinhada à esquerda */}
        <div className="relative flex-1 flex items-center justify-start ml-10">
        <div className="relative w-full">
            <img src={ikarusLogoWhite} alt="Ikarus" className="w-full h-auto" />
            <h1 className="absolute inset-0 flex items-center justify-center text-amber-700 font-bold text-[7vw] mt-10">
            Ikarus
            </h1>
        </div>
        </div>
